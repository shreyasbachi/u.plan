  ...
  return (
    <>
      ...
      <div className="flex flex-row gap-4 row-start-2 items-center">
        <div className="flex flex-col space-y-1 items-center px-8 ml-36">
          ...
          <div className="flex gap-2 items-center flex-col sm:flex-row">
            <Link href="/chat">
              <Button variant={"outline"} size={"lg"}>
                <MessageCircle className="size-5 mr-1 stroke-1" />
                Chat
              </Button>
            </Link>
        ...
        <Globe className="w-full max-w-[600px] mt-[5px] relative" />
      </div>
      <InfoCards />
      <footer className="bg-white ">
        <div className="container px-6 py-8 mx-auto">
          <hr className="my-6 border-muted md:my-10" />
